...
const plans = [
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    features: ["100,000 files, 1 TB storage", "1,000 data sources", "100 million AI tokens/month", "100 team members"],
    allFeatures: [
            ...
            >
              ...
              <button
                ...
                className={`w-full py-3 rounded-lg font-semibold transition-all touch-manipulation min-h-[48px] ${
                  plan.popular ? "holographic-glow" : "bg-muted hover:bg-muted/80 text-foreground"
                }`}
              >
                {plan.cta}
              </button>
