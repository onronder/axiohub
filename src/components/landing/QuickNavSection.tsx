...
const navOptions = [
  {
    ...
    description: 'Your Personal Safe.',
    detailedDescription: 'Analyze sensitive files in a private, encrypted session. When you leave, the data vanishes.',
  ...
  },
  {
    icon: Users,
    title: 'For Teams',
    description: 'The Digital Clean Room.',
    detailedDescription: 'A secure space for high-stakes projects. Upload, discuss, and decide. Then, the room self-destructs.',
  ...
  },
  {
    ...
    description: 'Zero Liability.',
    detailedDescription: 'We process your data but never store it. Eliminate data breach risks mathematically.',
