...
const plans = [
  ...
  },
  {
    ...
    included: ["Everything in Starter", "Axio Pro 🧠 smart AI", "Team collaboration (5 members)", "Priority support"],
    cta: "Upgrade to Pro",
    popular: true,
...
const faqs = [
  {
    ...
    answer:
      "Each connected folder, repository, or crawled domain counts as one data source (scope). For example, connecting one Google Drive folder = 1 source.",
  },
  {
    question: "What are AI tokens?",
    answer:
      "Tokens measure AI usage. Roughly, 1 token ≈ 4 characters. A typical question and answer uses about 1,000-3,000 tokens.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Never. Your data is used only to answer your questions. Ghost Protocol ensures original files are deleted after processing.",
  },
  {
